...
public class OneRecipeActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if(getIntent().getIntExtra("recipeCost", 0) != 0) recipeCostTextView.setText(String.valueOf(getIntent().getIntExtra("recipeCost", 0))+" TK");
        recipeCostTextView.setText(getIntent().getIntExtra("recipeCost", 0)!=1000 ? String.valueOf(getIntent().getIntExtra("recipeCost", 0))+" TK" : "N/A");
